...
public class LOTRRenderDorwinionElfVintner extends LOTRRenderElf {
    ...
    public LOTRRenderDorwinionElfVintner() {
        this.outfitTexture = new ResourceLocation("lotr:mob/elf/dorwinionVintner_cloak.png");
        this.capeTexture = new ResourceLocation("lotr:mob/elf/dorwinionVintner_cape.png");
