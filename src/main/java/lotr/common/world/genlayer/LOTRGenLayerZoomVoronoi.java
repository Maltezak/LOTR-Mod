...
public class LOTRGenLayerZoomVoronoi extends LOTRGenLayer {
    ...
    private double zoomDivisor = this.zoomScale - 0.5;
    ...
    public int[] getInts(World world, int i, int k, int xSize, int zSize) {
        ...
        for(int k3 = 0; k3 < zSizeZoom - 1; ++k3) {
            ...
            for(i3 = 0; i3 < xSizeZoom - 1; ++i3) {
                ...
                this.initChunkSeed(i3 + i1 << 2, k3 + k1 + 1 << 2);
                ...
                this.initChunkSeed(i3 + i1 + 1 << 2, k3 + k1 + 1 << 2);
